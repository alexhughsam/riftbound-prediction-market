...
const CATALOG: SampleSpec[] = [
  ...
  { name: 'Jinx, Loose Cannon PSA 9', set: 'Origins (Graded)', number: '045/298', rarity: 'Legendary', kind: 'slab', base: 74, vol: 0.05 },
  { name: 'Teemo Promo PSA 10', set: 'Promos (Graded)', number: 'P-001', rarity: 'Promo', kind: 'slab', base: 520, vol: 0.05 },
  { name: 'Teemo Promo PSA 9', set: 'Promos (Graded)', number: 'P-001', rarity: 'Promo', kind: 'slab', base: 298, vol: 0.05 },
  { name: 'Teemo Promo BGS 9.5', set: 'Promos (Graded)', number: 'P-001', rarity: 'Promo', kind: 'slab', base: 355, vol: 0.06 },
